...
<body class="body-color">
    <header class="flex header-color p-2 justify-between border-solid border-b-2 header-border-color shadow-colored sticky z-50">
        ...
        <div class="text-[3em] dark:text-white"><p>Ferrari</p></div>
    ...
    <?php
                ...
                if ($conn) {
                    if (mysqli_error($conn)) {
                        ...
                        printCar("Ferrari", "Kombi");
                        printCar("Ferrari", "Coupe");
                        printCar("Ferrari", "Cabrio");
                        printCar("Ferrari", "Limo");
                        printCar("Ferrari", "SUV");
                        printCar("Ferrari", "Sportwagen");
                    }
                } else {
