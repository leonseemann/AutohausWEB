...
<body class="body-color">
    <header class="flex header-color p-2 justify-between border-solid border-b-2 header-border-color shadow-colored sticky z-50">
        ...
        <div class="text-[3em] dark:text-white"><p>Lamborghini</p></div>
    ...
    <?php
                ...
                if ($conn) {
                    if (mysqli_error($conn)) {
                        ...
                        printCar("Lamborghini", "Kombi");
                        printCar("Lamborghini", "Coupe");
                        printCar("Lamborghini", "Cabrio");
                        printCar("Lamborghini", "Limo");
                        printCar("Lamborghini", "SUV");
                        printCar("Lamborghini", "Sportwagen");
                    }
                } else {
