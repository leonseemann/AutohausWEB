...
<body class="body-color">
    <header class="flex header-color p-2 justify-between border-solid border-b-2 header-border-color shadow-colored sticky z-50">
        ...
        <div class="text-[3em] dark:text-white"><p>Nissan</p></div>
    ...
    <?php
                ...
                if ($conn) {
                    if (mysqli_error($conn)) {
                        ...
                        printCar("Nissan", "Kombi");
                        printCar("Nissan", "Coupe");
                        printCar("Nissan", "Cabrio");
                        printCar("Nissan", "Limo");
                        printCar("Nissan", "SUV");
                        printCar("Nissan", "Sportwagen");
                    }
                } else {
