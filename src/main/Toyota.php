...
<body class="body-color">
    <header class="flex header-color p-2 justify-between border-solid border-b-2 header-border-color shadow-colored sticky z-50">
        ...
        <div class="text-[3em] dark:text-white"><p>Toyota</p></div>
    ...
    <?php
                ...
                if ($conn) {
                    if (mysqli_error($conn)) {
                        ...
                        printCar("Toyota", "Kombi");
                        printCar("Toyota", "Coupe");
                        printCar("Toyota", "Cabrio");
                        printCar("Toyota", "Limo");
                        printCar("Toyota", "SUV");
                        printCar("Toyota", "Sportwagen");
                    }
                } else {
